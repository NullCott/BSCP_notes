...
![Pasted image 20251102002709.png](img/
________####_Lab:_CSRF_where_token_validation_depends_on_request_method
...
#### Lab: CSRF where token is tied to non-session cookie
![Pasted image 20251102020725.png](img/
________####_Lab:_CSRF_where_token_validation_depends_on_request_method
...
![Pasted image 20251102022025.png](img/
________####_Lab:_CSRF_where_token_validation_depends_on_request_method
...
![Pasted image 20251102022031.png](img/
________####_Lab:_CSRF_where_token_validation_depends_on_request_method
